...
class adsr
{
    ...
    public:
        ...
        adsr(int dacSize, float attack_alpha, float attack_decay_release, bool bezier, int bezier_attack_type, int bezier_decay_release_type);
        ...
        void changeCurves(int dacSize, float attack_alpha, float attack_decay_release);
        
        void adsrCurveAttack(Point P1, Point P2, double maxVal, int numPoints);
        void adsrCurveDecayRelease(Point P1, Point P2, double maxVal, int numPoints);
    private:
